ladies_child_array =["トップス","ジャケット・アウター","パンツ","スカート","ワンピース","靴","ルームウェア・パジャマ","レッグウェア","帽子","バッグ","アクセサリー","ヘアアクセサリー","小物","時計","ウィッグ/エステ","浴衣/水着","スーツ/フォーマル/ドレス","マタニティ"]
ladies_grand_child_array = [
...
ladies_child_array.each_with_index do |child, i|
  ...
  ladies_grand_child_array[i].each do |grandchild|
    child.children.create(name: grandchild)
  end
end

mens_child_array =["トップス","ジャケットアウター","パンツ","靴","バック","スーツ","帽子","アクセサリー","小物","時計","水着","レッグウエア","アンダーウエア","その他"]
mens_grand_child_array = [
...
mens_child_array.each_with_index do |child, i|
  child = parent.children.create(name: child)
  mens_grand_child_array[i].each do |grandchild|
    child.children.create(name: grandchild)
  end
end
...
baby_kids_child_array.each_with_index do |child, i|
  child = parent.children.create(name: child)
  baby_kids_grand_child_array[i].each do |grandchild|
    child.children.create(name: grandchild)
  end
end

interior_residence_accessory_child_array =["キッチン/食器","ベッド/マットレス","ソファ/ソファベッド","椅子/チェア","机/テーブル","収納家具","ラグ/カーペット/マット","カーテン/ブラインド","ライト/照明","寝具","インテリア小物","季節/年中行事""その他"]
interior_residence_accessory_grand_child_array = [
...
interior_residence_accessory_child_array.each_with_index do |child, i|
  child = parent.children.create(name: child)
  interior_residence_accessory_grand_child_array[i].each do |grandchild|
    child.children.create(name: grandchild)
  end
end

book_music_game_child_array =["本","漫画","雑誌","CD","DVD/ブルーレイ","レコード","テレビゲーム"]
book_music_game_grand_child_array = [
...
cosme_perfume_beauty_child_array.each_with_index do |child, i|
  child = parent.children.create(name: child)
  cosme_perfume_beauty_grand_child_array[i].each do |grandchild|
    child.children.create(name: grandchild)
  end
end

appliance_smartphone_camera_child_array =["スマートフォン/携帯電話","スマホアクセサリー","PC/タブレット","カメラ","テレビ/映像機器","オーディオ機器","美容/健康","美容/健康","生活家電","その他"]
appliance_smartphone_camera_grand_child_array = [
...
handmade_child_array.each_with_index do |child, i|
  child = parent.children.create(name: child)
  handmade_grand_child_array[i].each do |grandchild|
    child.children.create(name: grandchild)
  end
end

ticket_child_array =["音楽","スポーツ","演劇/芸能","イベント","映画","施設利用券","優待券/割引券","その他"]
ticket_grand_child_array = [
...
others_child_array.each_with_index do |child, i|
  child = parent.children.create(name: child)
  others_grand_child_array[i].each do |grandchild|
    child.children.create(name: grandchild)
  end
end
